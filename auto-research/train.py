"""
train.py — Liveness detection: EfficientNet-B0 6-channel with improved recipe.
Optimized for fast training on DGX1.
"""
...
def build_model(num_classes=2):
    """EfficientNet-B0 modified for 6-channel input."""
...
def train():
    ...
    approach = "efficientnet_b0_6ch_label_smooth_onecycle_strong_aug_160px"
