...
Experiment: ResNet18 6ch + focal loss + MixUp + OneCycleLR + strong aug + TTA
"""
import os
import sys
import json
...
def train():
    ...
    print(f"Model: ResNet18 (6-ch) + FocalLoss + MixUp + OneCycleLR, params: {num_params:,}")
    ...
    for epoch in range(epochs):
        ...
        for imgs, targets in train_loader:
            ...
            mixed_imgs, y_a, y_b, lam = mixup_data(imgs, targets, alpha=0.4)
            optimizer.zero_grad()
    ...
    approach = "resnet18_6ch_focal_mixup_onecyclelr_strong_aug"
