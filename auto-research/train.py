...
Experiment: EfficientNet-B2 6ch + cosine warmup + label smoothing 0.1 + RandAugment
EfficientNet-B2 has better accuracy/FLOPS tradeoff than B0. 
Using a proper warmup schedule and RandAugment instead of manual augmentation.
"""
import os
import sys
import json
...
class LivenessDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            far_img = Image.new("RGB", (260, 260))
            near_img = Image.new("RGB", (260, 260))
...
def build_model(num_classes=2):
    """EfficientNet-B2 pretrained, modified for 6-channel input."""
...
def train():
    ...
    print(f"Model: EfficientNet-B2 (6-ch) + cosine warmup + label smoothing, params: {num_params:,}")
    ...
    approach = "efficientnet_b2_6ch_cosine_warmup_labelsmooth_randaugment"
